        ...
        <div class="col-lg-12">
            ...
            <% 
                ...
                try{
                    ...
                    PreparedStatement psSelect = conn.prepareStatement("select *  from  accounts,user,transaction where accounts.user_id = user.id and transaction.action='deposit' and transaction.account_number = accounts.acc_id and user.id =? limit 3");
